...
namespace ECTool.Scripts.Scriptables.Vegetation.Tree
{
    public class TrunkSO : VegetationSo
    {
        ...
        [Range(4, 24)] public int sides = 12;
        ...
        [Range(1, 180f)] public float bend = 1.0f;
        [Range(0.0f, 90f)] public float twist = 0.0f;
        [Range(0.0f, 0.4f)] public float sinStrength = 0f;
        [Range(0.0f, 2.0f)] public float sinFrequency = 0.0f;
        [Range(0.0f, 0.25f)] public float noise = 0.0f;
